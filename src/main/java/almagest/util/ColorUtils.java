...
{
    public static final float[][] TEFF_RGB = new float[][] {
                {2300, 1.0f, 0.491f, 0.144f},
                {2400, 1.0f, 0.518f, 0.179f},
                {2500, 1.0f, 0.542f, 0.202f},
                {2600, 1.0f, 0.607f, 0.255f},
                {2700, 1.0f, 0.648f, 0.286f},
                {2800, 1.0f, 0.649f, 0.285f},
                {2900, 1.0f, 0.644f, 0.285f},
                {3000, 1.0f, 0.641f, 0.289f},
                {3100, 1.0f, 0.638f, 0.293f},
                {3200, 1.0f, 0.638f, 0.3f},
                {3300, 1.0f, 0.638f, 0.308f},
                {3400, 1.0f, 0.638f, 0.315f},
                {3500, 1.0f, 0.637f, 0.322f},
                {3600, 1.0f, 0.635f, 0.327f},
                {3700, 1.0f, 0.637f, 0.34f},
                {3800, 1.0f, 0.635f, 0.346f},
                {3900, 1.0f, 0.636f, 0.354f},
                {4000, 1.0f, 0.641f, 0.369f},
                {4100, 1.0f, 0.65f, 0.389f},
                {4200, 1.0f, 0.662f, 0.411f},
                {4300, 1.0f, 0.677f, 0.439f},
                {4400, 1.0f, 0.696f, 0.47f},
                {4500, 1.0f, 0.717f, 0.501f},
                {4600, 1.0f, 0.739f, 0.533f},
                {4700, 1.0f, 0.761f, 0.565f},
                {4800, 1.0f, 0.781f, 0.595f},
                {4900, 1.0f, 0.802f, 0.626f},
                {5000, 1.0f, 0.821f, 0.657f},
                {5100, 1.0f, 0.84f, 0.691f},
                {5200, 1.0f, 0.857f, 0.722f},
                {5300, 1.0f, 0.872f, 0.753f},
                {5400, 1.0f, 0.886f, 0.783f},
                {5500, 1.0f, 0.898f, 0.813f},
                {5600, 1.0f, 0.91f, 0.845f},
                {5700, 1.0f, 0.922f, 0.878f},
                {5800, 1.0f, 0.931f, 0.905f},
                {5900, 1.0f, 0.94f, 0.931f},
                {6000, 1.0f, 0.951f, 0.967f},
                {6100, 1.0f, 0.96f, 0.998f},
                {6200, 0.955f, 0.931f, 1.0f},
                {6300, 0.922f, 0.908f, 1.0f},
                {6400, 0.896f, 0.891f, 1.0f},
                {6500, 0.869f, 0.871f, 1.0f},
                {6600, 0.844f, 0.855f, 1.0f},
                {6700, 0.823f, 0.84f, 1.0f},
                {6800, 0.802f, 0.826f, 1.0f},
                {6900, 0.782f, 0.812f, 1.0f},
                {7000, 0.763f, 0.799f, 1.0f},
                {7200, 0.725f, 0.773f, 1.0f},
                {7400, 0.692f, 0.75f, 1.0f},
                {7600, 0.674f, 0.738f, 1.0f},
                {7800, 0.636f, 0.712f, 1.0f},
                {8000, 0.606f, 0.69f, 1.0f},
                {8200, 0.579f, 0.67f, 1.0f},
                {8400, 0.556f, 0.652f, 1.0f},
                {8600, 0.546f, 0.645f, 1.0f},
                {8800, 0.531f, 0.634f, 1.0f},
                {9000, 0.519f, 0.624f, 1.0f},
                {9200, 0.508f, 0.616f, 1.0f},
                {9400, 0.498f, 0.608f, 1.0f},
                {9600, 0.49f, 0.601f, 1.0f},
                {9800, 0.483f, 0.595f, 1.0f},
                {10000, 0.477f, 0.59f, 1.0f},
                {10200, 0.472f, 0.586f, 1.0f},
                {10400, 0.467f, 0.582f, 1.0f},
                {10600, 0.463f, 0.578f, 1.0f},
                {10800, 0.459f, 0.575f, 1.0f},
                {11000, 0.456f, 0.572f, 1.0f},
                {11200, 0.453f, 0.57f, 1.0f},
                {11400, 0.451f, 0.567f, 1.0f},
                {11600, 0.45f, 0.566f, 1.0f},
                {11800, 0.448f, 0.564f, 1.0f},
                {12000, 0.446f, 0.562f, 1.0f},
                {12500, 0.44f, 0.557f, 1.0f},
                {13000, 0.436f, 0.554f, 1.0f},
                {13500, 0.432f, 0.55f, 1.0f},
                {14000, 0.429f, 0.547f, 1.0f},
                {14500, 0.425f, 0.544f, 1.0f},
                {15000, 0.421f, 0.541f, 1.0f},
                {16000, 0.414f, 0.536f, 1.0f},
                {17000, 0.408f, 0.532f, 1.0f},
                {18000, 0.403f, 0.527f, 1.0f},
                {19000, 0.398f, 0.524f, 1.0f},
                {20000, 0.394f, 0.52f, 1.0f},
                {21000, 0.39f, 0.517f, 1.0f},
                {22000, 0.387f, 0.514f, 1.0f},
                {23000, 0.384f, 0.512f, 1.0f},
                {24000, 0.381f, 0.509f, 1.0f},
                {25000, 0.379f, 0.507f, 1.0f},
                {26000, 0.376f, 0.505f, 1.0f},
                {27000, 0.373f, 0.503f, 1.0f},
                {27500, 0.371f, 0.501f, 1.0f},
                {28000, 0.371f, 0.5f, 1.0f},
                {29000, 0.368f, 0.498f, 1.0f},
                {30000, 0.366f, 0.496f, 1.0f},
                {32500, 0.361f, 0.491f, 1.0f},
                {35000, 0.357f, 0.487f, 1.0f},
                {37500, 0.359f, 0.487f, 1.0f},
                {40000, 0.358f, 0.486f, 1.0f},
                {42500, 0.357f, 0.485f, 1.0f},
                {45000, 0.357f, 0.485f, 1.0f},
                {47500, 0.357f, 0.485f, 1.0f},
                {50000, 0.358f, 0.486f, 1.0f},
                {52500, 0.359f, 0.487f, 1.0f},
                {55000, 0.361f, 0.489f, 1.0f}};
    ...
    public static Color getColor(double[] c)
    {
        return new Color(c[0], c[1], c[2], c[3]);
    }
    ...
    {
        return new Color(c.get(0).floatValue(), 
                         c.get(1).floatValue(), 
                         c.get(2).floatValue(), 
                         c.get(3).floatValue());
    }
    ...
    /**
     * Converts from {@link almagest.util.Color} to {@link java.awt.Color}
     **/
     ...
     */
    public static void initHarreData()
    {
        if (teffToRGB_harre == null)
        {
            teffToRGB_harre = TEFF_RGB;
        }
    }
    ...
    public static Color tEffToRGB(double tEff)
    {
        float[] rgb = tEffToRGB_harre(tEff);
