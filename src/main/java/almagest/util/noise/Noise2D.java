...
public interface Noise2D
{
    ...
    {
        return (x, y) -> easeInOutExpo(Noise2D.this.noise(x, y), min, max);
    }

    default Noise2D easeInOutExpoNorm(double min, double max, double lowerBound, double upperBound)
    {
        return (x, y) -> easeInOutExpoNorm(Noise2D.this.noise(x, y), min, max, lowerBound, upperBound);
    }

    default Noise2D easeOutInExpo(double min, double max)
    {
        return (x, y) -> easeOutInExpo(Noise2D.this.noise(x, y), min, max);
    }

    default Noise2D easeInExpo(double min, double max)
    {
        return (x, y) -> easeInExpo(Noise2D.this.noise(x, y), min, max);
    }

    default Noise2D easeOutExpo(double min, double max)
    {
        return (x, y) -> easeOutExpo(Noise2D.this.noise(x, y), min, max);
    }
