...
public class Color
{
    ...
    {
		List<Double> rgba = new ArrayList<>(4);
		rgba.add((double) this.red());
		rgba.add((double) this.green());
		rgba.add((double) this.blue());
		rgba.add((double) this.alpha());
		return rgba;
    }

    public List<Integer> toListRGBA()
    {
		List<Integer> rgba = new ArrayList<>(4);
		rgba.add((int) (this.red() * 255.0F));
		rgba.add((int) (this.green() * 255.0F));
		rgba.add((int) (this.blue() * 255.0F));
		rgba.add((int) (this.alpha() * 255.0F));
		return rgba;
    }
	...
	/** Sets this Color's alpha value.
	 * 
	 * @param a Alpha component
	 * 
	 * @return this Color for chaining */
	public Color set(float a)
	{
		this.a = a;
		return clamp();
	}
	...
	/** Sets this Color's component values.
	 * 
	 * @param list A list of all color components
	 * 
	 * @return this Color for chaining */
	public Color set(List<Float> rgba)
	{
		this.r = getOrDefault(rgba, 0, 1.0F);
		this.g = getOrDefault(rgba, 1, 1.0F);
		this.b = getOrDefault(rgba, 2, 1.0F);
		this.a = getOrDefault(rgba, 3, 1.0F);
		return clamp();
	}
	...
	/**
	 * Returns the color as a string of normalized RGBA components,
	 * e.g. "1.0, 1.0, 1.0, 1.0".
	 *
	...
	/**
	 * Helper method to safely get a value from a list or return a default.
	 *
	 * @param list The list to access
	 * @param index The index to retrieve
	 * @param defaultValue The value to return if index is out of bounds
	 * @return The value at index or defaultValue
	 */
	public static float getOrDefault(List<Float> list, int index, float defaultValue)
	{
